          ...
          children: [
            ...
            InkWell(child: Row(children: [
              ...
              splashColor:Colors.black12, onTap: () {
               ...
               /* OperationdataInsert().deleteeway(
                    "notes","id = ${widget.id}");*/
                print(widget.id);
            ...
            InkWell(child: Row(children: [
              ...
              splashColor:Colors.black12, onTap: (){Navigator.of(context).pop('Home');}, ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor:  colorsItem[passedColor],
        centerTitle: true,
        toolbarHeight: 80,
        actions: [
          ...
          IconButton(icon:Icon(Icons.done),onPressed: () async {
            ...
            if (_formKey.currentState!.validate()) {
              OperationdataInsert().UpdataData(title.text, note.text, passedColor, widget.id);
              Navigator.of(context).pushReplacementNamed('Home');
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: colorsItem[passedColor], fontSize: 23),
                        hintMaxLines: 2,
                        labelText: "Title",
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(color: colorsItem[passedColor], width: 3),
                        ),
                        prefixIcon:  Icon(Icons.note,color: colorsItem[passedColor],),
                      ),
                      validator: (value) {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.description,color: colorsItem[passedColor],),
                      ),
